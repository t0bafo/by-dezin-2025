...
export const FinalCTA: React.FC<FinalCTAProps> = ({ onBrandApplicationClick }) => {
  return (
    <section id="rsvp" className="bg-cream min-h-[50vh] flex items-center py-20 mobile:py-24 tablet:py-28 desktop:py-32">
      <div className="max-w-7xl mx-auto px-6 mobile:px-8 w-full">
        <div className="text-center animate-fade-in">
          {/* Main Headline */}
          <HeadingXL className="text-black mb-8 font-semibold leading-tight tracking-[-0.02em]">
            Join Us in New York
          </HeadingXL>

          {/* Event Details */}
          <BodyM className="text-black mb-12 opacity-90 tracking-[0.01em]">
            September 13, 2025
          </BodyM>

          {/* Body Copy */}
          <div className="max-w-[640px] mx-auto mb-16">
            <BodyM className="text-black leading-relaxed opacity-90 tracking-[0.005em] text-lg">
