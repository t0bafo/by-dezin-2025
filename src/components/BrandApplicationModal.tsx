      ...
      <div className="bg-bone rounded-xl w-full max-w-lg mobile:w-4/5 tablet:w-2/5 max-h-[90vh] overflow-y-auto shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          <div className="space-y-3">
            <Label htmlFor="brand-fullName" className="text-black font-medium tracking-[0.005em]">
              Full Name *
            </Label>
            <Input
              id="brand-fullName"
          ...
          <div className="space-y-3">
            <Label htmlFor="brand-email" className="text-black font-medium tracking-[0.005em]">
              Email Address *
            </Label>
            <Input
              id="brand-email"
          ...
          <div className="space-y-3">
            <Label htmlFor="brand-brandName" className="text-black font-medium tracking-[0.005em]">
              Brand Name *
            </Label>
            <Input
              id="brand-brandName"
          ...
          <div className="space-y-3">
            <Label htmlFor="brand-website" className="text-black font-medium tracking-[0.005em]">
              Website / Instagram *
            </Label>
            <Input
              id="brand-website"
